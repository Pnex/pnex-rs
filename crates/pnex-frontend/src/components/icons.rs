...
icon!(User, "M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2", "M12 3a4 4 0 1 0 0 8 4 4 0 0 0 0-8");
...
icon!(Search, "M11 3a8 8 0 1 0 0 16 8 8 0 0 0 0-16", "m21 21-4.3-4.3");
icon!(Trash2, "M3 6h18", "M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6", "M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2", "M10 11v6", "M14 11v6");
icon!(Check, "M20 6 9 17l-5-5");
icon!(LogOut, "M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4", "m16 17 5-5-5-5", "M21 12H9");
...
icon!(Download, "M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4", "m7 10 5 5 5-5", "M12 15V3");
icon!(BookOpen, "M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z", "M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z");
icon!(ShoppingCart, "M6 6h15l-1.58 7.42a2 2 0 0 1-1.96 1.58H8.4a2 2 0 0 1-1.96-1.58L4.5 3H2", "M9 20a1 1 0 1 0 0 2 1 1 0 0 0 0-2", "M18 20a1 1 0 1 0 0 2 1 1 0 0 0 0-2");

// Statuts
icon!(CheckCircle, "M22 11.08V12a10 10 0 1 1-5.93-9.14", "m9 11 3 3L22 4");
icon!(AlertTriangle, "m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z", "M12 9v4", "M12 17h.01");
icon!(Info, "M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20", "M12 16v-4", "M12 8h.01");
