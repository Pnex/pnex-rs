...
flows-readonly-banner = Read-only preview — go back to the latest version to edit.
...
flows-runtime-unknown = Engine unknown
...
flows-palette-add = Add to canvas
...
flows-versions-previewing-prefix = Previewing
